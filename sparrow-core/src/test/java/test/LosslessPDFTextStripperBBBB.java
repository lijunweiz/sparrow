 ...
 * 无损抽取pdf内容
 */
public class LosslessPDFTextStripperBBBB extends PDFTextStripper {
     ...
     */
    public LosslessPDFTextStripperBBBB() throws IOException {
    ...
    private void writeLine(final List<TextPosition> textPositionList) {
        if (Objects.nonNull(textPositionList) && textPositionList.size() > 0) {
    ...
    class TextLine {
        ...
        public TextLine(int lineLength) {
            this.line = "";
            this.lineLength = lineLength / OUTPUT_SPACE_CHARACTER_WIDTH_IN_PT;
    ...
    class CharacterFactory {
        ...
        public Character createCharacterFromTextPosition(final TextPosition textPosition, final TextPosition previousTextPosition) {
            ...
            int index = (int)textPosition.getX() / OUTPUT_SPACE_CHARACTER_WIDTH_IN_PT;
        ...
        private boolean isCharacterCloseToPreviousWord(final TextPosition textPosition) {
            ...
            double numberOfSpaces = this.numberOfSpacesBetweenTwoCharacters(previousTextPosition, textPosition);
            return (numberOfSpaces > 1 && numberOfSpaces <= OUTPUT_SPACE_CHARACTER_WIDTH_IN_PT);
        }
